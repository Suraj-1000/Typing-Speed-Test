...
import { User, Lock, Keyboard, ArrowRight } from 'lucide-react';
    ...
    <div className="flex items-center justify-center min-h-[80vh] px-4 relative select-none">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-muted-foreground text-xs font-mono mt-1 uppercase tracking-widest">Sign in to track velocity</p>
        </div>
